...
public class AstarteFormatterIntegrationTest {
  ...
  public static Iterable<Object[]> data() throws IOException {
    Path testDataPath = Paths.get("com/google/googlejavaformat/java/testdata-astarte");
    ClassLoader classLoader = AstarteFormatterIntegrationTest.class.getClassLoader();
    ...
    for (ResourceInfo resourceInfo : ClassPath.from(classLoader).getResources()) {
      ...
      if (resourceNamePath.startsWith(testDataPath)) {
        ...
        try (InputStream stream =
            AstarteFormatterIntegrationTest.class.getClassLoader().getResourceAsStream(resourceName)) {
  ...
  public AstarteFormatterIntegrationTest(String name, String input, String expected) {
    this.name = name;
    this.input = input;
    this.expected = expected;
    this.separator = Newlines.getLineEnding(expected);
    JavaFormatterOptions.Builder builder = JavaFormatterOptions.builder();
    builder.style(JavaFormatterOptions.Style.ASTARTE);
  ...
  public void idempotentLF() {
    try {
      ...
      String output = new Formatter(this.options).formatSource(mangled);
